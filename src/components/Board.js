...
const Board = () => {
    ...
    const [boardList, setBoardList] = useState([
        { no: "1", title: '상품의 판매, 재입고 일정을 알고싶어요', description: '품절 된 상품 입고 일정을 알고싶어요.', viewCount: 1 },
        { no: "2", title: '구매한 상품을 매장에서 교환할 수 있나요?', description: '온라인 스토어에 구매한 상품을 오프라인 매장에서 교환하고싶어요.', viewCount: 2 },
        { no: "3", title: '쿠폰 사용 방법을 알고싶어요.', description: '쿠폰을 사용하려고 합니다 방법 알려주세요.', viewCount: 1 },
        { no: "4", title: '일부 배송되었어요.', description: '구매한 상품 일부만 도착했어요 나머지는 언제 배송되나요?', viewCount: 1 }
    ]);
    ...
    <div className="container" style={{ marginTop: "100px" }}>
        ...
        {listOk && (
            <div style={{ marginTop: "30px" }}>
                    ...
                    <tbody>
                        {boardList.slice().reverse().map(board => (
                            <tr key={board.no}>
                                ...
                                <td>
                                    <Button variant="outline-dark" onClick={() => boardRead(board.no)}>
                                        게시글읽기
                                    </Button>
                                    <Button variant="outline-dark" onClick={() => boardEdit(board.no)} style={{ marginLeft: "10px" }}>수정</Button>
                                    <Button variant="outline-dark" onClick={() => boardDelete(board.no)} style={{ marginLeft: "10px" }}>
                                        삭제
                                    </Button>
                                </td>
                            </tr>
                ...
                <Button variant="dark" onClick={boardWrite} style={{ float: 'right' }}>
                   문의글 작성하기
                </Button>
            </div>
        )}
